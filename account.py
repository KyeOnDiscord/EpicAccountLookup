...
class ExternalAuth:
    ...
    def __init__(self, key, value) -> None:
        ...
        if key == "steam":
            self.profileURL = "http://steamcommunity.com/profiles/" + \
                urllib.parse.quote(self.externalAuthId)
        if key == "xbl":
            self.profileURL = "https://account.xbox.com/en-us/profile?gamertag=" + \
                urllib.parse.quote(self.displayName)
        if key == "psn":
            self.profileURL = "https://psnprofiles.com/" + \
                urllib.parse.quote(self.displayName)
